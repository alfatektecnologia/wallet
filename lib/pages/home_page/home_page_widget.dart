...
import '/components/private_key_dialog_widget.dart';
...
class _HomePageWidgetState extends State<HomePageWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.addressWallet = FFAppState().wallet.address;
      safeSetState(() {});
    });
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: MorallisWebGroup.getTokenBalanceByWalletCall.call(
        walletAddress: FFAppState().wallet.address,
      ...
      builder: (context, snapshot) {
        ...
        final homePageGetTokenBalanceByWalletResponse = snapshot.data!;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if ((FFAppState().showSeed == false) &&
                        (FFAppState().wallet.mnemonic != ''))
                      Padding(
                        padding:
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    // show_seed
                                    FFAppState().showSeed = true;
                                    safeSetState(() {});
                                    await Clipboard.setData(ClipboardData(
                                        text: FFAppState().wallet.mnemonic));
                            ...
                            Builder(
                              builder: (context) => FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (FFAppState().isConfirmed) {
                                    _model.mnemonic = actions.getMnemonic(
                                      context,
                                    );
                                    FFAppState().updateWalletStruct(
                                      (e) => e..mnemonic = _model.mnemonic,
                                    );
                                    safeSetState(() {});
                                    _model.privateKey =
                                        await actions.getPrivateKey(
                                      context,
                                      FFAppState().wallet.mnemonic,
                                    );
                                    FFAppState().updateWalletStruct(
                                      (e) => e..privateKey = _model.privateKey,
                                    );
                                    safeSetState(() {});
                                    _model.address = await actions.getPublicKey(
                                      context,
                                      FFAppState().wallet.privateKey,
                                    );
                                    FFAppState().updateWalletStruct(
                                      (e) => e..address = _model.address,
                                    );
                                    FFAppState().account = _model.address!;
                                    FFAppState().createdWallet = true;
                                    safeSetState(() {});
                                  }
                                    ...
                                    return Dialog(
                                      ...
                                      child: GestureDetector(
                                        onTap: () =>
                                            FocusScope.of(dialogContext)
                                                .unfocus(),
                                        child: const PrivateKeyDialogWidget(),
                                      ),
                                    );
                                  },
                                );
                          ...
                          Align(
                            ...
                            child: TabBar(
                              ...
                              onTap: (i) async {
                                [
                                  () async {
                                    _model.apiResultq74 = await MorallisWebGroup
                                        .getBalanceCall
                                        .call(
                                      walletAddress:
                                          FFAppState().wallet.address,
                                    ...
                                    if ((_model.apiResultq74?.succeeded ??
                                        true)) {
                                      FFAppState().balance =
                                          valueOrDefault<String>(
                                        getJsonField(
                                          (_model.apiResultq74?.jsonBody ?? ''),
                                          r'''$.balance''',
                                        )?.toString(),
                                        '0',
                                      );
                                  ...
                                  () async {
                                    _model.apiResultiws = await MorallisWebGroup
                                        .getNFTbyWalletCall
                                        .call(
                                      walletAddress:
                                          FFAppState().wallet.address,
                                    ...
                                    if ((_model.apiResultiws?.succeeded ??
                                        true)) {
                                      FFAppState().updateNftStruct(
                                        (e) => e
                                          ..result = NftStruct.maybeFromMap(
                                                  (_model.apiResultiws
                                                          ?.jsonBody ??
                                                      ''))!
                                              .result
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            ...
                                            return ListView.builder(
                                              ...
                                              shrinkWrap: true,
                                              scrollDirection: Axis.vertical,
                                              itemCount: listNFT.length,
                                              itemBuilder:
                                                  (context, listNFTIndex) {
                                                final listNFTItem =
                                                    listNFT[listNFTIndex];
                                                return Row(
                                                  mainAxisSize:
                                                      MainAxisSize.max,
                                                  children: [
                                                      ...
                                                      child: ClipRRect(
                                                        borderRadius:
                                                            BorderRadius
                                                                .circular(8.0),
                                                        child: Image.network(
                                                          'https://firebasestorage.googleapis.com/v0/b/zooners-wallet-dqwm28.appspot.com/o/logo_zooners2.jpg?alt=media&token=e72988de-c522-43b7-885f-3d7178b1bb3e',
                                                          width: 100.0,
                                                          height: 100.0,
                                                          fit: BoxFit.cover,
